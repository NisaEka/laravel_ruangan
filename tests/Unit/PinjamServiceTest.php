...
class PinjamServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(PinjamService::class);
        $this->originalArray = [
            'id' => '1',
		'tanggal' => '2019-05-23',
		'user_id' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Pinjam');
    ...
    public function testUpdate()
    {
        ...
        $this->assertDatabaseHas('pinjams', $this->editedArray);
    }
