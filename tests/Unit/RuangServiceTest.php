...
class RuangServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(RuangService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => '1',
		'status' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Ruang');
    ...
    public function testUpdate()
    {
        ...
        $this->assertDatabaseHas('ruangs', $this->editedArray);
    }
